...
const PythonPage = () => {
    ...
    useEffect(() => {
        const fetchPrograms = async () => {
            try {
                const response = await axios.get('https://tch-nellify-2.onrender.com/python-programs');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (selectedProgram) {
                ...
                await axios.put(`https://tch-nellify-2.onrender.com/python-programs/${selectedProgram._id}`, programData);
                setSnackbarMessage('Program updated successfully!');
            } else {
                // Add new program
                await axios.post('https://tch-nellify-2.onrender.com/python-programs', programData);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://tch-nellify-2.onrender.com/python-programs/${id}`);
